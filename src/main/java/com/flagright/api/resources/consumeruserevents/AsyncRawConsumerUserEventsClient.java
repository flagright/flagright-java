...
public class AsyncRawConsumerUserEventsClient {
     ...
     */
    public CompletableFuture<FlagrightHttpResponse<ConsumerUserEventWithRulesResult>> get(String eventId) {
     ...
     * You can retrieve any consumer user event you created using the <a href="/api-reference/api-reference/consumer-user-events/create">POST Consumer User Events</a> call.
     */
    public CompletableFuture<FlagrightHttpResponse<ConsumerUserEventWithRulesResult>> get(
        ...
        CompletableFuture<FlagrightHttpResponse<ConsumerUserEventWithRulesResult>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
