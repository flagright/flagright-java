...
public class AsyncRawTransactionsClient {
     ...
     * </ul>
     */
    public CompletableFuture<FlagrightHttpResponse<TransactionsVerifyResponse>> verify(
            TransactionsVerifyRequest request) {
    ...
    public CompletableFuture<FlagrightHttpResponse<TransactionsVerifyResponse>> verify(
        ...
        CompletableFuture<FlagrightHttpResponse<TransactionsVerifyResponse>> future = new CompletableFuture<>();
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new FlagrightHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBody.string(), TransactionsVerifyResponse.class),
                                response));
                        return;
                    }
     ...
     */
    public CompletableFuture<FlagrightHttpResponse<TransactionWithRulesResult>> get(String transactionId) {
     ...
     * <p>Calling <code>GET /transactions/{transactionId}</code> will return the entire transaction payload and rule execution results for the transaction with the corresponding <code>transactionId</code></p>
     */
    public CompletableFuture<FlagrightHttpResponse<TransactionWithRulesResult>> get(
        ...
        CompletableFuture<FlagrightHttpResponse<TransactionWithRulesResult>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new FlagrightHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBody.string(), TransactionWithRulesResult.class),
                                response));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
