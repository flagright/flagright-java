...
public class RawTransactionsClient {
     ...
     * </ul>
     */
    public FlagrightHttpResponse<TransactionsVerifyResponse> verify(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new FlagrightHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), TransactionsVerifyResponse.class),
                        response);
            }
     ...
     */
    public FlagrightHttpResponse<TransactionWithRulesResult> get(String transactionId) {
     ...
     * <p>Calling <code>GET /transactions/{transactionId}</code> will return the entire transaction payload and rule execution results for the transaction with the corresponding <code>transactionId</code></p>
     */
    public FlagrightHttpResponse<TransactionWithRulesResult> get(String transactionId, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new FlagrightHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), TransactionWithRulesResult.class),
                        response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            try {
