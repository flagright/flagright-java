...
public class AsyncRawBusinessUsersClient {
     ...
     * </ul>
     */
    public CompletableFuture<FlagrightHttpResponse<BusinessUsersCreateResponse>> create(
            BusinessUsersCreateRequest request) {
    ...
    public CompletableFuture<FlagrightHttpResponse<BusinessUsersCreateResponse>> create(
        ...
        CompletableFuture<FlagrightHttpResponse<BusinessUsersCreateResponse>> future = new CompletableFuture<>();
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new FlagrightHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBody.string(), BusinessUsersCreateResponse.class),
                                response));
                        return;
                    }
     ...
     */
    public CompletableFuture<FlagrightHttpResponse<BusinessWithRulesResult>> get(String userId) {
     ...
     * <p>Calling <code>GET /business/user/{userId}</code> will return the entire User payload and rule execution results for the User with the corresponding <code>userId</code></p>
     */
    public CompletableFuture<FlagrightHttpResponse<BusinessWithRulesResult>> get(
