 ...
 */
package com.flagright.api.resources.businessusers.types;
...
import com.flagright.api.types.IBusinessUserMonitoringResult;
...
@JsonDeserialize(builder = BusinessUsersCreateResponse.Builder.class)
public final class BusinessUsersCreateResponse implements IBusinessUserMonitoringResult {
    ...
    private BusinessUsersCreateResponse(
            String userId,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BusinessUsersCreateResponse && equalTo((BusinessUsersCreateResponse) other);
    }
    ...
    private boolean equalTo(BusinessUsersCreateResponse other) {
    ...
    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.userId, this.riskScoreDetails, this.hitRules, this.executedRules, this.message);
    }
    ...
    public interface UserIdStage {
        ...
        Builder from(BusinessUsersCreateResponse other);
    }

    public interface _FinalStage {
        BusinessUsersCreateResponse build();
    ...
    public static final class Builder implements UserIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(BusinessUsersCreateResponse other) {
        ...
        @java.lang.Override
        public BusinessUsersCreateResponse build() {
            return new BusinessUsersCreateResponse(
                    userId, riskScoreDetails, hitRules, executedRules, message, additionalProperties);
        }
    }
}
