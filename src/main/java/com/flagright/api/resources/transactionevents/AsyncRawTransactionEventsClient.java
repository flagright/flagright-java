...
public class AsyncRawTransactionEventsClient {
    protected final ClientOptions clientOptions;

    public AsyncRawTransactionEventsClient(ClientOptions clientOptions) {
     ...
     */
    public CompletableFuture<FlagrightHttpResponse<TransactionEventMonitoringResult>> create(TransactionEvent request) {
     ...
     * <p>In order to make individual events retrievable, you also need to pass in a unique <code>eventId</code> to the request body.</p>
     */
    public CompletableFuture<FlagrightHttpResponse<TransactionEventMonitoringResult>> create(
        ...
        CompletableFuture<FlagrightHttpResponse<TransactionEventMonitoringResult>> future = new CompletableFuture<>();
     ...
     */
    public CompletableFuture<FlagrightHttpResponse<TransactionEventWithRulesResult>> get(String eventId) {
     ...
     * <p>You can retrieve any transaction event you created using the <a href="/api-reference/api-reference/transaction-events/create">POST Transaction Events</a> call.</p>
     */
    public CompletableFuture<FlagrightHttpResponse<TransactionEventWithRulesResult>> get(
        ...
        CompletableFuture<FlagrightHttpResponse<TransactionEventWithRulesResult>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
