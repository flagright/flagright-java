...
public class RawBusinessUserEventsClient {
     ...
     */
    public FlagrightHttpResponse<BusinessUserEventsCreateResponse> create(BusinessUserEventsCreateRequest request) {
     ...
     * <p>In order to make individual events retrievable, you also need to pass in a unique <code>eventId</code> to the request body.</p>
     */
    public FlagrightHttpResponse<BusinessUserEventsCreateResponse> create(
            ...
            if (response.isSuccessful()) {
                return new FlagrightHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(
                                responseBody.string(), BusinessUserEventsCreateResponse.class),
                        response);
            }
