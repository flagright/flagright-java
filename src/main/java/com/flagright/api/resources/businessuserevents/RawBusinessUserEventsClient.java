...
public class RawBusinessUserEventsClient {
    protected final ClientOptions clientOptions;

    public RawBusinessUserEventsClient(ClientOptions clientOptions) {
     ...
     */
    public FlagrightHttpResponse<BusinessWithRulesResult> create(BusinessUserEventsCreateRequest request) {
     ...
     * <p>In order to make individual events retrievable, you also need to pass in a unique <code>eventId</code> to the request body.</p>
     */
    public FlagrightHttpResponse<BusinessWithRulesResult> create(
     ...
     */
    public FlagrightHttpResponse<BusinessUserEventWithRulesResult> get(String eventId) {
     ...
     * You can retrieve any business user event you created using the <a href="/api-reference/api-reference/business-user-events/create">POST Business User Events</a> call.
     */
    public FlagrightHttpResponse<BusinessUserEventWithRulesResult> get(String eventId, RequestOptions requestOptions) {
