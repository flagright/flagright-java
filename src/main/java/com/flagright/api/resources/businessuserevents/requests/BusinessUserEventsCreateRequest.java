 ...
 */
package com.flagright.api.resources.businessuserevents.requests;
...
@JsonDeserialize(builder = BusinessUserEventsCreateRequest.Builder.class)
public final class BusinessUserEventsCreateRequest {
    ...
    private BusinessUserEventsCreateRequest(
    ...
    /**
     * @return Boolean string whether Flagright should allow a Business user event to be applied to a Consumer user with the same user ID. This will converts a Consumer user to a Business user.
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BusinessUserEventsCreateRequest && equalTo((BusinessUserEventsCreateRequest) other);
    }
    ...
    private boolean equalTo(BusinessUserEventsCreateRequest other) {
    ...
    public interface BodyStage {
        _FinalStage body(@NotNull BusinessUserEvent body);

        Builder from(BusinessUserEventsCreateRequest other);
    }

    public interface _FinalStage {
        BusinessUserEventsCreateRequest build();
    ...
    public static final class Builder implements BodyStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(BusinessUserEventsCreateRequest other) {
        ...
        /**
         * <p>Boolean string whether Flagright should allow a Business user event to be applied to a Consumer user with the same user ID. This will converts a Consumer user to a Business user.</p>
         * @return Reference to {@code this} so that method calls can be chained together.
         */
        @java.lang.Override
