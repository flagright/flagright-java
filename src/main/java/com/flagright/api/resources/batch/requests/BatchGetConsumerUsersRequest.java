...
@JsonDeserialize(builder = BatchGetConsumerUsersRequest.Builder.class)
public final class BatchGetConsumerUsersRequest {
    ...
    private BatchGetConsumerUsersRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BatchGetConsumerUsersRequest && equalTo((BatchGetConsumerUsersRequest) other);
    }
    ...
    private boolean equalTo(BatchGetConsumerUsersRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(BatchGetConsumerUsersRequest other) {
        ...
        public BatchGetConsumerUsersRequest build() {
            return new BatchGetConsumerUsersRequest(pageSize, page, additionalProperties);
        }
    }
}
