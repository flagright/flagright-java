...
@JsonDeserialize(builder = BatchGetBusinessUserEventsRequest.Builder.class)
public final class BatchGetBusinessUserEventsRequest {
    ...
    private BatchGetBusinessUserEventsRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BatchGetBusinessUserEventsRequest && equalTo((BatchGetBusinessUserEventsRequest) other);
    }
    ...
    private boolean equalTo(BatchGetBusinessUserEventsRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(BatchGetBusinessUserEventsRequest other) {
        ...
        public BatchGetBusinessUserEventsRequest build() {
            return new BatchGetBusinessUserEventsRequest(pageSize, page, additionalProperties);
        }
    }
}
