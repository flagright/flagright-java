...
@JsonDeserialize(builder = BatchGetTransactionsRequest.Builder.class)
public final class BatchGetTransactionsRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BatchGetTransactionsRequest && equalTo((BatchGetTransactionsRequest) other);
    }
    ...
    private boolean equalTo(BatchGetTransactionsRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(BatchGetTransactionsRequest other) {
        ...
        public BatchGetTransactionsRequest build() {
            return new BatchGetTransactionsRequest(pageSize, page, additionalProperties);
        }
    }
}
