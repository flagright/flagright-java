...
@JsonDeserialize(builder = BatchGetBusinessUsersRequest.Builder.class)
public final class BatchGetBusinessUsersRequest {
    ...
    private BatchGetBusinessUsersRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof BatchGetBusinessUsersRequest && equalTo((BatchGetBusinessUsersRequest) other);
    }
    ...
    private boolean equalTo(BatchGetBusinessUsersRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(BatchGetBusinessUsersRequest other) {
        ...
        public BatchGetBusinessUsersRequest build() {
            return new BatchGetBusinessUsersRequest(pageSize, page, additionalProperties);
        }
    }
}
