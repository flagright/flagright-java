...
@JsonDeserialize(builder = PersonWithRole.Builder.class)
public final class PersonWithRole {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PersonWithRole && equalTo((PersonWithRole) other);
    }
    ...
    private boolean equalTo(PersonWithRole other) {
    ...
    public interface GeneralDetailsStage {
        RoleStage generalDetails(@NotNull UserDetails generalDetails);

        Builder from(PersonWithRole other);
    }
    ...
    public static final class Builder implements GeneralDetailsStage, RoleStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(PersonWithRole other) {
        ...
        public RoleStage generalDetails(@NotNull UserDetails generalDetails) {
