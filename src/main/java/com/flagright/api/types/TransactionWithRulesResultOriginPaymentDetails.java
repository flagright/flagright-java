...
public final class TransactionWithRulesResultOriginPaymentDetails {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private TransactionWithRulesResultOriginPaymentDetails(Value value) {
        this.value = value;
    }
    ...
    public static TransactionWithRulesResultOriginPaymentDetails card(CardDetails value) {
        return new TransactionWithRulesResultOriginPaymentDetails(new CardValue(value));
    }

    public static TransactionWithRulesResultOriginPaymentDetails genericBankAccount(GenericBankAccountDetails value) {
        return new TransactionWithRulesResultOriginPaymentDetails(new GenericBankAccountValue(value));
    }

    public static TransactionWithRulesResultOriginPaymentDetails iban(IbanDetails value) {
        return new TransactionWithRulesResultOriginPaymentDetails(new IbanValue(value));
    }

    public static TransactionWithRulesResultOriginPaymentDetails ach(AchDetails value) {
        return new TransactionWithRulesResultOriginPaymentDetails(new AchValue(value));
    }

    public static TransactionWithRulesResultOriginPaymentDetails swift(SwiftDetails value) {
        return new TransactionWithRulesResultOriginPaymentDetails(new SwiftValue(value));
    }

    public static TransactionWithRulesResultOriginPaymentDetails mpesa(MpesaDetails value) {
        return new TransactionWithRulesResultOriginPaymentDetails(new MpesaValue(value));
    }

    public static TransactionWithRulesResultOriginPaymentDetails upi(UpiDetails value) {
        return new TransactionWithRulesResultOriginPaymentDetails(new UpiValue(value));
    }

    public static TransactionWithRulesResultOriginPaymentDetails wallet(WalletDetails value) {
        return new TransactionWithRulesResultOriginPaymentDetails(new WalletValue(value));
    }

    public static TransactionWithRulesResultOriginPaymentDetails check(CheckDetails value) {
        return new TransactionWithRulesResultOriginPaymentDetails(new CheckValue(value));
    }

    public static TransactionWithRulesResultOriginPaymentDetails cash(CashDetails value) {
        return new TransactionWithRulesResultOriginPaymentDetails(new CashValue(value));
    }

    public static TransactionWithRulesResultOriginPaymentDetails npp(NppDetails value) {
        return new TransactionWithRulesResultOriginPaymentDetails(new NppValue(value));
    }
    ...
    private static final class CardValue implements Value {
        ...
        public String toString() {
            return "TransactionWithRulesResultOriginPaymentDetails{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "TransactionWithRulesResultOriginPaymentDetails{" + "type: " + type + ", value: " + value + "}";
        }
    }
}
